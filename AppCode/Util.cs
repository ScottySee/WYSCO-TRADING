...
public class Util
{
    ...
    //public static void PurchaseHistory(string PurchaseID, string Date, string Amount)
    //{
    //    using (SqlConnection con = new SqlConnection(GetConnection()))
    //    {
    //        con.Open();
    //        string query = @"INSERT INTO PurchaseHistory (PurchaseID, Date, Amount, DateAdded)
    //                            VALUES (@PurchaseID, @Date, @Amount, @DateAdded)";
    //        using (SqlCommand cmd = new SqlCommand(query, con))
    //        {
    ...
    //public static void SalesHistory(string SalesID, string Date, string Amount)
    //{
    //    using (SqlConnection con = new SqlConnection(GetConnection()))
    //    {
    //        con.Open();
    //        string query = @"INSERT INTO SalesHistory (SalesID, Date, Amount, DateAdded)
    //                            VALUES (@SalesID, @Date, @Amount, @DateAdded)";
    //        using (SqlCommand cmd = new SqlCommand(query, con))
    //        {
