<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeFile="Purchases.aspx.cs" Inherits="Purchases" ValidateRequest="false" %>
                    ...
                    <div class="row">
                        <div class="col-lg-1">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="purchaseID" runat="server" class="form-control" MaxLength="50" ReadOnly="true" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
