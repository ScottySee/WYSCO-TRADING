<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeFile="Supplier.aspx.cs" Inherits="Supplier" ValidateRequest="false" %>
        ...
        <form runat="server" classa="form-horizontal">
            ...
            <div class="card shadow-lg bg-info">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-1">
                            <div class="form-group text-darker">
                ...
                <div class="container">
                    <div class="col-lg-4">
                        <div class="input-group">
                            <asp:Button ID="btnAdd" runat="server" class="btn btn-lg btn-warning" Text="Add Supplier" OnClick="AddCompany" />
                            <asp:Button ID="btnEdit" runat="server" class="btn btn-lg btn-warning" Text="Update Supplier" OnClick="SaveCompany" />
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12 table">
                                <table id="dtSupplier" class="table table-striped">
                                    <thead>
                                        ...
                                        <asp:ListView ID="lvSupplier" runat="server">
                                            <ItemTemplate>
                                                <tr class="bg-default" style="text-align:center">
                                                    ...
                                                    <td><%# Eval("Status") %></td>
                                                    <td>
                                                        <a href='Supplier.aspx?EditID=<%# Eval("SupplierID") %>' class="btn btn-info btn-sm"><i class="fa fa-edit"></i>Edit</a>&nbsp;
                                                        <a href='Supplier.aspx?DeleteID=<%# Eval("SupplierID") %>' class="btn btn-danger btn-sm" onclick="return confirm('Do you want to archive this item?')"><i class="fa fa-trash"></i>Archive</a>&nbsp;
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <EmptyDataTemplate>
